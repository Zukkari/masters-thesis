...
%=== Info in English
    \newcommand\EngInfo{{%
        ...
        \noindent
        In recent years, quality code behind the presentation layer has become increasingly important since a high number of applications are in maintenance mode.
        ...
        of the previous tools by providing more code smells detection rules.
        As a result, we developed a plugin for SonarQube plugin that analyzes applications written in Java programming language.
